export declare type FFFSPath = string;
/**
...
export declare type WorkerFSFileEntry = File;
...
export declare type FFFSMountOptions = WorkerFSMountData;
...
export declare type FFMessageData = FFMessageLoadConfig | FFMessageExecData | FFMessageWriteFileData | FFMessageReadFileData | FFMessageDeleteFileData | FFMessageRenameData | FFMessageCreateDirData | FFMessageListDirData | FFMessageDeleteDirData | FFMessageMountData | FFMessageUnmountData;
...
export declare type FileData = Uint8Array | string;
export declare type IsFirst = boolean;
export declare type OK = boolean;
export interface FSNode {
    name: string;
    isDir: boolean;
}
export declare type CallbackData = FileData | ExitCode | ErrorMessage | LogEvent | ProgressEvent | IsFirst | OK | Error | FSNode[] | undefined;
export interface Callbacks {
    [id: number | string]: (data: CallbackData) => void;
}
export declare type LogEventCallback = (event: LogEvent) => void;
export declare type ProgressEventCallback = (event: ProgressEvent) => void;
